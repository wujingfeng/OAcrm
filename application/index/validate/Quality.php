...
class Quality extends Validate
{
    ...
    protected $scene = [
        ...
        #保存/更新人员信息
        'saveQuality'         =>      'customer_name,linkman,sex,link_number,landline_phone,customer_type,return_visit,time_visit,consult_cost,user_id'
    ];
