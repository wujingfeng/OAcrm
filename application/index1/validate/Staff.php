...
//        'cellphone.num'             =>  '电话号码格式错误',
    ...
    protected $scene = [
        ...
        #保存/更新人员信息
        'saveStaff'         =>      'name,sex,three_category,cellphone,bid_type,customer_type,talent_price,year,return_visit,time_visit,prepay,social_security,card_status,talent_type,consult_cost,id_card,user_id'
